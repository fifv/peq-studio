...
for (const [name, marker, exports] of [
  ['topping-dsp', '"getTransferFunction"', ['getTransferFunction', 'calculateFilterResponseDb', 'calculateCombinedResponseDb', 'normalizeFilterTypeCode', 'normalizeConfig', 'createFrequencyResponseKernel', 'fillFilterResponseDb']],
